...
namespace nts
{
    Component4071::Component4071(const std::string &name) : AGate(name, 14)
    {
    ...
    void Component4071::simulate(std::size_t tick)
    {
        ...
        for (size_t i = 0; i < 4; i++) {
            ...
            Tristate output = ORComponent::calculateState(input1, input2);
    ...
    Tristate Component4071::compute(std::size_t tick)
    {
        this->simulate(tick);
        return UNDEFINED;
    }
